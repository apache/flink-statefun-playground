...
APP_KAFKA_HOST = Arg(key="APP_KAFKA_HOST", default="kafka:9092", type=str)
APP_KAFKA_TOPIC = Arg(key="APP_KAFKA_TOPIC", default="word-frequency", type=str)
APP_DELAY_SECONDS = Arg(key="APP_DELAY_SECONDS", default="10", type=int)
APP_LOOP = Arg(key="APP_LOOP", default="false", type=lambda s: s.lower() == "true")
APP_JSON_PATH = Arg(key="APP_JSON_PATH", default="text", type=parse)
