 ...
 */
public final class TestBedAppServer {

  public static final int PORT = 1108;

  /**
   * Run this program to start a web server that handles invocations!
   *
   ...
   * and the served functions, you may also set breakpoints
  ...
  public static void main(String[] args) {
    ...
    functions.withStatefulFunction(wordCountFn);
